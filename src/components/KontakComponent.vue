...
<div class=" px-6 py-24 sm:py-32 lg:px-8">
  ...
  <div class="mx-auto max-w-2xl text-center">
    ...
    <br>
    <center><div style="width: 30%; background: grey; height: 4px; "></div></center>
  </div>
  <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
      ...
      <div class="sm:col-span-2">
        <label for="phone-number" class="block text-sm font-semibold leading-6 text-gray-900">Nomer Telepon</label>
      ...
      <div class="flex gap-x-4 sm:col-span-2">
        ...
        <label class="text-sm leading-6 text-gray-600" id="switch-1-label">
          Dengan memilih ini, Anda menyetujui kebijakan privasi kami.
